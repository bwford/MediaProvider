...
public class MtpService extends Service {
    ...
    private static final String USB_ATTACHED = TAG+"Attached";
    private static final String USB_DETACHED = TAG+"Detached";
    ...
    public void onCreate() {
        ...
        synchronized (mBinder) {
            ...
            sendBroadcast(new Intent(USB_ATTACHED));
    ...
    public void onDestroy() {
        sendBroadcast(new Intent(USB_DETACHED));
